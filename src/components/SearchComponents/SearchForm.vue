...
export default {
    ...
    $_getMusic(){
      ...
      let accessToken = 'BQCT2R8KaPZHi4fMEpzWKJKQpqT2fawtHMdvdvM_MnCrQM0Ntxey9Xj3FAM8MrQYWtEhQ2x-OpR7acc48yapnlSfQ6XvDBLYqpT4IhBLIGq2dNcsNUyy6DZtmQK35dOKo-HvGGp6BfqST8S2-vF-IRNWAZnSAgMYS1_faWbyRuGjz00qFnw&token_type=Bearer&expires_in=3600&state=123';
